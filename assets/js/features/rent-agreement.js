...
import { g, sv, toast, fmtDate, fmtMoney, esc, closeModal, stampPdfReference } from '../helpers.js';
...
window.generateRentAgreementPdf = async()=>{
  ...
  // Reference-only watermark + legal disclaimer on every page (also applies to
  // the stored copy generated via pdf.output below)
  stampPdfReference(pdf, { type:"agreement", watermark:"REFERENCE COPY" });
